							<!-- 고객상담일지 목록 파일 -->
								...
								<div style="height:336px;">
									...
									<div style="width:100px; padding-top:4px; border-width:0 0 1px 0; text-align:center;" class="bor_ddd"><a href="<?$cms_url?>?m_di=1&amp;s_di=1&amp;ss_di=2&amp;mode=modify&amp;seq=<?=$rows[seq]?>" class="no_auth"><?=$rows[cust_name]?></a></div>
									...
									<div style="width:240px; padding:4px 0 0 10px; border-width:0 0 1px 1px;" class="bor_ddd"><?=rg_cut_string($rows[content],25,"...")?></div>
									<div style="width:170px; padding:4px 0 0 10px; border-width:0 0 1px 1px;" class="bor_ddd"><?=rg_cut_string($rows[memo], 18, "..")?></div>
									<?
											}
										}
									?>
