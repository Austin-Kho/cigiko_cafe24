							<!-- 부서 신규 수정 등록 파일 -->
								...
								<div style="height:447px;">
									...
									<div style="clear:left; float:left; width:120px; height:26px; padding:5px 0 0 15px; border-width:1px 1px 1px 0; border-style:solid; border-color:#dddddd; background-color:#E2F0FC; color:#003366;" class="blue_title">고객명 <font color="red">*</font></div>
									...
									<div style="float:left; width:120px; height:26px; padding:5px 0 0 15px; border-width:1px 1px 1px 0; border-style:solid; border-color:#dddddd; background-color:#E2F0FC; color:#003366;" class="blue_title">상담일자 <font color="red">*</font></div>
									...
									<div style="clear:left; float:left; width:120px; height:26px; padding:5px 0 0 15px; border-width:0 1px 1px 0; border-style:solid; border-color:#dddddd; background-color:#E2F0FC; color:#003366;" class="blue_title">연락처1 <font color="red">*</font></div>
									<div style="float:left; width:240px; height:26px; padding:5px 0 0 10px; border-width:0 0 1px 0; border-style:solid; border-color:#dddddd; "><input type="text" name="cust_tel1" value="<?=$row[cust_tel1]?>" class="inputstyle2" style="width:160px"></div>
									<div style="float:left; width:120px; height:26px; padding:5px 0 0 15px; border-width:0 1px 1px 0; border-style:solid; border-color:#dddddd; background-color:#E2F0FC; color:#003366;" class="blue_title">연락처2</div>
									...
									<div style="clear:left; float:left; width:120px; height:26px; padding:5px 0 0 15px; border-width:0 1px 1px 0; border-style:solid; border-color:#dddddd; background-color:#E2F0FC; color:#003366;" class="blue_title">상담경로 <font color="red">*</font></div>
									...
									<div style="float:left; width:120px; height:26px; padding:5px 0 0 15px; border-width:0 1px 1px 0; border-style:solid; border-color:#dddddd; background-color:#E2F0FC; color:#003366;" class="blue_title">관심타입(평형)</div>
									...
									<div style="clear:left; float:left; width:120px; height:26px; padding:5px 0 0 15px; border-width:0 1px 1px 0; border-style:solid; border-color:#dddddd; background-color:#E2F0FC; color:#003366;" class="blue_title">거주지역 (형태)</div>
									...
									<div style="float:left; width:120px; height:26px; padding:5px 0 0 15px; border-width:0 1px 1px 0; border-style:solid; border-color:#dddddd; background-color:#E2F0FC; color:#003366;" class="blue_title">관 심 도</div>
									<div style="float:left; width:240px; height:26px; padding:5px 0 0 10px; border-width:0 0 1px 0; border-style:solid; border-color:#dddddd; ">
									...
									<div style="clear:left; float:left; width:120px; height:210px; padding:5px 0 0 15px; border-width:0 1px 1px 0; border-style:solid; border-color:#dddddd; background-color:#E2F0FC; color:#003366;" class="blue_title">상담내용 <font color="red">*</font></div>
									...
									<div style="clear:left; float:left; width:120px; height:26px; padding:5px 0 0 15px; border-width:0 1px 1px 0; border-style:solid; border-color:#dddddd; background-color:#E2F0FC; color:#003366;" class="blue_title">메 모 </div>
