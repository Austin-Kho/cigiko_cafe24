							<!-- 업무일지 목록 파일 -->
								...
								<div style="height:336px;">
									...
									<div style="width:180px; text-align:center;" class="blue_title">현장명</div>
									<div style="width:100px; text-align:center;" class="blue_title">소속본부 </div>
									<div style="width:100px; text-align:center;" class="blue_title">소속 팀 </div>
									<div style="width:110px; text-align:center;" class="blue_title">작성자</div>
									<div style="width:148px; border-width:1px 0 1px 0; text-align:center;" class="blue_title">비 고</div>
									<?
										/*****기본 표시 목록*****/
									...
									<div style="width:180px; border-width:0 0 1px 0; text-align:center;" class="bor_ddd"><?=$dt_row[pj_name]?></div><!-- 현장명 -->
									<div style="width:100px; border-width:0 0 1px 1px; text-align:center;" class="bor_ddd"><?=$dt_row[headq]?></div><!-- 소속본부 -->
									<div style="width:100px; border-width:0 0 1px 1px; text-align:center;" class="bor_ddd"><?=$dt_row[team]?></div><!-- 소속 팀 -->
									<div style="width:110px; border-width:0 0 1px 1px; text-align:center;" class="bor_ddd"><?=$dt_row[name]?></div><!-- 작성자 -->
									<div style="width:138px; padding:6px 0 0 10px; border-width:0 0 1px 1px; " class="bor_ddd"><?=rg_cut_string($rows[d_sale_act], 20, "..")?></div><!-- 비 고 -->
									<?
											}
										}
									?>
