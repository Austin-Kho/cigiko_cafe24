...
$error['FR'][PolymorphicArgumentException] = "Mod챔le inadmissible d'argument pour la fonction polymorphe.".
$error['DE'][PolymorphicArgumentException] = "Unzul채ssiges Argumentmuster f체r polymorphe Funktion.";
...
$error['DE'][ArgumentTypeException] = "Unzul채ssige Argumentart.";
...
$error['DE'][ArgumentBoundsException] = "Unzul채ssige Argumentstrecke.";

define('MatrixDimensionException', -4);
$error['EN'][MatrixDimensionException] = "Matrix dimensions are not equal.";
$error['FR'][MatrixDimensionException] = "Les dimensions de Matrix ne sont pas 챕gales.";
$error['DE'][MatrixDimensionException] = "Matrixma횩e sind nicht gleich.";

define('PrecisionLossException', -5);
$error['EN'][PrecisionLossException] = "Significant precision loss detected.";
$error['FR'][PrecisionLossException] = "Perte significative de pr챕cision d챕tect챕e.";
$error['DE'][PrecisionLossException] = "Bedeutender Pr채zision Verlust ermittelte.";

define('MatrixSPDException', -6);
$error['EN'][MatrixSPDException] = "Can only perform operation on symmetric positive definite matrix.";
$error['FR'][MatrixSPDException] = "Perte significative de pr챕cision d챕tect챕e.";
$error['DE'][MatrixSPDException] = "Bedeutender Pr채zision Verlust ermittelte.";
