					...
					<!-- =====subject table end===== -->
					<?
						$cg_1_3_rlt = mysql_query("select cg_1_3 from cms_mem_auth where user_id='$_SESSION[p_id]' ", $connect);
						$cg_1_3_row = mysql_fetch_array($cg_1_3_rlt);

						if(!$cg_1_3_row[cg_1_3]||$cg_1_3_row[cg_1_3]==0){
					?>
