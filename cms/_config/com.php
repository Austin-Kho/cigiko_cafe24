				...
				<tr>
					...
					<tr>
						...
						<td align="center" width="162" class="d2_sub2">
							<a href="<?=$_SERVER['PHP_SELF']?>?m_di=1"><img src="../images/sub_menu_config1_.png" border="0" alt="" /><!-- <font size="2" color=""><b>기본정보관리</b></font> --></a></td>
						<td align="center" width="162" class="d2_sub1">
							<a href="<?=$_SERVER['PHP_SELF']?>?m_di=2"><img src="../images/sub_menu_config2.png" border="0" alt="" /><!-- <font size="2" color=""><b>회사정보관리</b></font> --></a></td>
