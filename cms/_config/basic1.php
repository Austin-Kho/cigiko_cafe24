					...
					<!-- =========================subject table end======================= -->
					<?
						$cg_1_1_rlt = mysql_query("select cg_1_1 from cms_mem_auth where user_id='$_SESSION[p_id]' ", $connect);
						$cg_1_1_row = mysql_fetch_array($cg_1_1_rlt);

						if(!$cg_1_1_row[cg_1_1]||$cg_1_1_row[cg_1_1]==0){
					?>
