					...
					<tr>
						...
						<td width="35%" class="form2">
							...
							<input type="text" name="co_no1" value="<?=$co_no[0]?>" size="5" maxlength="3" readonly class="inputstyle2" onkeyup="focus_move(this,3,co_no2);" onmouseover="cngClass(this,'inputstyle22')" onmouseout="cngClass(this,'inputstyle2');"> -
							<input type="text" name="co_no2" value="<?=$co_no[1]?>" size="4" maxlength="2" readonly class="inputstyle2" onkeyup="focus_move(this,2,co_no3);" onmouseover="cngClass(this,'inputstyle22')" onmouseout="cngClass(this,'inputstyle2');"> -
							<input type="text" name="co_no3" value="<?=$co_no[2]?>" size="8" maxlength="5" readonly class="inputstyle2" onkeyup="focus_move(this,5,co_form);" onmouseover="cngClass(this,'inputstyle22')" onmouseout="cngClass(this,'inputstyle2');">
							<select name="co_form" class="inputstyle2">
