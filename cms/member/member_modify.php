<?
	global $cms_url, $cms_path, $mini_path, $count_n, $member, $hidden_id, $total_memberzero;
 ...
 <div style="width:756px; height:100%; margin:0px auto;"><!-- wrap div -->
	...
	<div style="background-color:#FFFFFF; border-width:0 2px 2px 2px; border-color:#96ABE5; border-style:solid; padding:10px;">
		...
		<div style="float:left; width:512px; height:25px; padding:5px 0 0 20px;">
			<input type="text" name="user_id" value="<?=$rows[user_id]?>" style="ime-mode:disabled;" size='22' class='inputstyle2' maxlength="12" onmouseover="cngClass(this,'inputstyle22')" onmouseout="cngClass(this,'inputstyle2');" disabled>
		</div>
		...
		<div style="float:left; width:512px; height:28px; border-width:0 0 1px 0; border-color:#E1E1E1; border-style:solid; padding:5px 0 0 20px;">
			<input type="text" name="jumin1" value="<?=$pass[0]?>" size="15" class="inputstyle2" maxlength="6" onkeyup="focus_move(this,6,jumin2);" onmouseover="cngClass(this,'inputstyle22')" onmouseout="cngClass(this,'inputstyle2');" disabled>
			-
			<input type="password" name="jumin2" value="<?=$pass[1]?>" size="16" maxlength="7" class="inputstyle2" onmouseover="cngClass(this,'inputstyle22')" onmouseout="cngClass(this,'inputstyle2');" disabled>
		</div>
		...
		<div style="float:left; width:512px; height:28px; border-width:0 0 1px 0; border-color:#E1E1E1; border-style:solid; padding:5px 0 0 20px;">
			...
			<input type="button" value="우편번호 검색" onclick="javascript:ZipWindow('zip_search.php')" class="inputstyle_bt">
		</div>
