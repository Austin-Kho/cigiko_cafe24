					...
					<!-- ===== subject table end ===== -->
					<?
						$ct_2_1_rlt = mysql_query("select ct_2_1 from cms_mem_auth where user_id='$_SESSION[p_id]' ", $connect);
						$ct_2_1_row = mysql_fetch_array($ct_2_1_rlt);

						if(!$ct_2_1_row[ct_2_1]||$ct_2_1_row[ct_2_1]==0){
					?>
