...
<?
	...
	if($page_code=='new_reg'){ // 신규 등록이면
		...
		$query="INSERT INTO `cms_project_info` ( `pj_name`, `sort`, `local_addr`, `local_tel`, `local_fax`, `pj_manager`, `type_info`, `color_type`, `total_count_type`, `sell_count_type`, `count_unit`, `per_pay_type`, `pay_con`, `client`, `client_res`, `client_res_tel`, `client_res_mail`, `start_date`, `expiry_date`, `cont_date`, `pay_sp_condition`, `reg_date`)

							 VALUES('$pj_name', '$sort', '$address', '$local_tel', '$local_fax', '$pj_manager', '$type', '$color', '$total_count', '$sell_count', '$count_unit', '$pay', '$pay_con', '$client', '$client_res', '$client_res_tel', '$client_res_mail', '$start_date', '$expiry_date', '$cont_date', '$pay_sp_con', now())";
