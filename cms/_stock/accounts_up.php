 ...
 <head>
	...
	<!--
		...
		*/
		...
		var a = confirm('거래처 정보를 등록 하시겠습니까?')
		if(a==true){
			form.submit();
		} else {
			return;
	...
	<tr>
		<td align="center" style="border-width: 2 0 0 0; border-color:#C5FAC9; border-style: solid; padding:6 0 0 0px">
			...
			<tr height="80" bgcolor="#D9EAF8">
				...
				<font color="#4C63BD" style="font-size:11pt"><b>거래처 등록</b></font>
				</td>
			</tr>			
			<tr bgcolor="ffffff">
				...
				<tr height="28">
					<td>
					<form name="form1" action="accounts_up_post.php" method="post">
					<table border="0" width="100%" height="100%" cellspacing="0" cellpadding="0">
					<tr align="center" height="35">
						<td width="100%" bgcolor="#F4F4F4" style="border-width: 1 0 1 0; border-color:#CFCFCF; border-style: solid;" colspan="3">
							등록할 거래처 정보를 입력해 주십시요. (<font color="#ff0000">*</font>표시는 필수입력 정보)
						</td>
					</tr>
					<tr>					
						<td style="padding:18 0 0 16px"> 사이트명(별칭) </td>
						<td style="padding:18 0 0 0px" colspan="2">
							<input type="text" name="si_name" size="30" class="inputStyle2" style="height:20px" onmouseover="cngClass(this,'inputStyle22')" onmouseout="cngClass(this,'inputStyle2');"> 							
						</td>
					</tr>
					<tr>					
						<td style="padding:10 0 0 16px"> 거래처명 <font color="#ff0000">*</font></td>
						<td style="padding:10 0 0 0px" colspan="2">
							<input type="text" name="acc_name" size="30" class="inputStyle2" style="height:20px" onmouseover="cngClass(this,'inputStyle22')" onmouseout="cngClass(this,'inputStyle2');"> 							
						</td>
					</tr>
					<tr>
						<td style="padding:10 0 0 16px"> 사업자등록번호 <font color="#ff0000">*</font></td>
						<td style="padding:10 0 0 0px" colspan="2">
							<input type="text" name="co_no1" size="5" maxlength="3" class="inputStyle2" style="height:20px" onmouseover="cngClass(this,'inputStyle22')" onmouseout="cngClass(this,'inputStyle2');"> -
							<input type="text" name="co_no2" size="5" maxlength="2" class="inputStyle2" style="height:20px" onmouseover="cngClass(this,'inputStyle22')" onmouseout="cngClass(this,'inputStyle2');"> -
							<input type="text" name="co_no3" size="9" maxlength="5" class="inputStyle2" style="height:20px" onmouseover="cngClass(this,'inputStyle22')" onmouseout="cngClass(this,'inputStyle2');">
						</td>
					</tr>
					<tr>
						...
						<td style="padding:10 0 0 0px" >
							<select name="acc_cla" onChange="rate_Op()" style="width:80">
								...
								<option value="1"> 매입 거래처
								<option value="2"> 매출 거래처
								<option value="3"> 매입·매출 거래처
							</select>
						</td>
						<td style="padding:10 0 0 0px">
							수수료율 : 
							<input type="text" name="co_rate" size="5" maxlength="5" class="inputStyle2" style="height:20px" onmouseover="cngClass(this,'inputStyle22')" onmouseout="cngClass(this,'inputStyle2');" disabled> %
						</td>
					</tr>
					<tr>
						<td style="padding:10 0 0 16px"> 담당자 <font color="#ff0000">*</font></td>
						<td style="padding:10 0 0 0px" colspan="2">
							<input type="text" name="acc_worker" size="30" class="inputStyle2" style="height:20px" onmouseover="cngClass(this,'inputStyle22')" onmouseout="cngClass(this,'inputStyle2');"> 							
						</td>
					</tr>
					<tr>					
						<td style="padding:10 0 0 16px"> 연락처 <font color="#ff0000">*</font></td>
						<td style="padding:10 0 0 0px" colspan="2">
							<input type="text" name="phone" size="30" class="inputStyle2" style="height:20px" onmouseover="cngClass(this,'inputStyle22')" onmouseout="cngClass(this,'inputStyle2');">
						</td>
					</tr>					
					<tr>					
						...
						<td style="padding:10 0 23 0px; border-width: 0 0 1 0; border-color:#CFCFCF; border-style: solid;" colspan="2">
							<input type="text" name="address" size="38" class="inputStyle2" style="height:20px" onmouseover="cngClass(this,'inputStyle22')" onmouseout="cngClass(this,'inputStyle2');"> 							
						</td>
					</tr>
