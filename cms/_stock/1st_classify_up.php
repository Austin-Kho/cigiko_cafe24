...
<html>
 <head>
	...
	<!--
		...
		var a = confirm('대분류 정보를 등록 하시겠습니까?')
		if(a==true){
			form.submit();
		} else {
			return;
	...
	<tr>
		<td align="center" style="border-width: 2 0 0 0; border-color:#C5FAC9; border-style: solid; padding:6 0 0 0px">
			...
			<tr height="80" bgcolor="#D9EAF8">
				...
				<font color="#4C63BD" style="font-size:11pt"><b>대분류(CATEGORY) 등록</b></font>
				</td>
			</tr>			
			<tr bgcolor="ffffff">
				...
				<tr height="28">
					<td>
					<form name="form1" action="1st_classify_up_post.php" method="post">
					<table border="0" width="100%" height="100%" cellspacing="0" cellpadding="0">
					<tr align="center" height="35">
						<td width="100%" bgcolor="#F4F4F4" style="border-width: 1 0 1 0; border-color:#CFCFCF; border-style: solid;" colspan="2">
							등록할 대분류 정보를 입력해 주십시요. (<font color="#ff0000">*</font>표시는 필수입력 정보)
						</td>
					</tr>
					<tr>					
						<td style="padding:25 0 0 16px"> 대분류명 <font color="#ff0000">*</font></td>
						<td style="padding:25 0 0 0px">
							<input type="text" name="category" size="40" class="inputStyle2" style="height:20px" onmouseover="cngClass(this,'inputStyle22')" onmouseout="cngClass(this,'inputStyle2');"> 							
						</td>
					</tr>				
					<tr>					
