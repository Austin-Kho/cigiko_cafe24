<?
	...
	$query="select * from cms_stock_2nd_classify where no='$edit_code'";
...
<html>
 <head>
	...
	<!--
		...
		var a = confirm('중분류 정보를 수정 하시겠습니까?')
		if(a==true){
			form.submit();
		} else {
			return;
	...
	<tr>
		<td align="center" style="border-width: 2 0 0 0; border-color:#C5FAC9; border-style: solid; padding:6 0 0 0px">
			...
			<tr height="80" bgcolor="#D9EAF8">
				...
				<font color="#4C63BD" style="font-size:11pt"><b>중분류(BRAND) 정보수정</b></font>
				</td>
			</tr>
			<tr bgcolor="ffffff">
				...
				<tr height="28">
					<td>
					<form name="form1" action="2nd_classify_edit_post.php" method="post">
					...
					<tr align="center" height="35">
						<td width="100%" bgcolor="#F4F4F4" style="border-width: 1 0 1 0; border-color:#CFCFCF; border-style: solid;" colspan="2">
							변경할 중분류 정보를 수정해 주십시요. (<font color="#ff0000">*</font>표시는 필수입력 정보)
						</td>
					</tr>
					<tr>
						<td style="padding:25 0 0 16px"> 카테고리 </td>
						<td style="padding:25 0 0 0px"> <font color="#5f7da3"><b><?=$rows[1]?></b></font> </td>
					</tr>
					<tr>
						<td style="padding:25 0 0 16px"> 브랜드명 <font color="#ff0000">*</font></td>
						<td style="padding:25 0 0 0px">
							<input type="text" name="brand" value="<?=$rows[classify]?>" size="40" class="inputStyle2" style="height:20px" onmouseover="cngClass(this,'inputStyle22')" onmouseout="cngClass(this,'inputStyle2');">
						</td>
					</tr>				
					<tr>					
						...
						<td style="padding:12 0 23 0px; border-width: 0 0 1 0; border-color:#CFCFCF; border-style: solid;">
							<textarea name="note" rows="8" cols="38" class="inputStyle2" onmouseover="cngClass(this,'inputStyle22')" onmouseout="cngClass(this,'inputStyle2');"><?=$rows[note];?></textarea>							
						</td>
					</tr>					
					<tr align="center">
				...
				<tr>
					...
					<tr>
						<td align="center">
							...
							<input type="button" value=" 목록으로 " onclick="location.href('2nd_classify.php?category=<?=$category?>&brand=<?=$brand?>&fn=<?=$fn?>&frm=<?=$frm?>');" class="inputstyle1">
						</td>
					</tr>
					</table>
					</form>
