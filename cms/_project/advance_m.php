				...
				<tr>
					...
					<tr>
						...
						<td align="center" width="162" class="d2_sub1">
							<a href="<?=$_SERVER['PHP_SELF']?>?m_di=1"><img src="../images/sub_menu_field1.png" border="0" alt=""><!-- <font size="2" color=""><b>전도금 관리</b></font> --></a></td>
						<td align="center" width="162" class="d2_sub2">
							<a href="<?=$_SERVER['PHP_SELF']?>?m_di=2"><img src="../images/sub_menu_field2_.png" border="0" alt=""><!-- <font size="2" color=""><b>투입자원 관리</b></font> --></a></td>
