	...
	// 이름 앞에 붙는 얼굴 아이콘
        function get_face($data, $check=0) {
                ...
                if($group[use_icon]==0) {
                        ...
                        $level=$level_temp[0];
                                if($level==10) $face_image="<img src=images/10.gif>"; 
                                elseif($level==9) $face_image="<img src=images/09.gif>"; 
                                elseif($level==8) $face_image="<img src=images/08.gif>"; 
                                elseif($level==7) $face_image="<img src=images/07.gif>"; 
                                elseif($level==6) $face_image="<img src=images/06.gif>"; 
                                elseif($level==5) $face_image="<img src=images/05.gif>"; 
                                elseif($level==4) $face_image="<img src=images/04.gif>"; 
                                elseif($level==3) $face_image="<img src=images/03.gif>"; 
                                elseif($level==2) $face_image="<img src=images/02.gif>"; 
                                elseif($level==1) $face_image="<img src=images/01.gif>"; 
                                else {
                                        if($group[icon]) $face_image="<img src=icon/$group[icon] border=0 align=absmiddle>";
                                        else $face_image="<img src=images/10.gif border=0 align=absmiddle>";
                                }
                        } 
                        else $face_image="<img src=images/10.gif border=0 align=absmiddle> ";
                }
