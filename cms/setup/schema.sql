...
$send_memo_table="cms_send_memo";      //받은 메모 테이블
...
create table cms_division_$table_name (
...
$board_table_main_schema ="
  ...
  create table cms_board_$table_name (
...
$board_comment_schema ="
  ...
  create table cms_board_comment_$table_name (
...
$board_category_table ="
  create table cms_board_category_$table_name (
    no int(11) not null auto_increment primary key ,
