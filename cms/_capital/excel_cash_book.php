...
<table border="1">
	<tr align="center" height="45">
			<td colspan="10" style="font-size:15pt; text-align:center;"><b>본사 금전 출납부</b></td>
	</tr>
	<tr align="center" height="35">
			...
			<td width="100" bgcolor="#EAEAEA">입금계정</td>
			<td width="100" bgcolor="#EAEAEA">지출금액</td>
			<td width="100" bgcolor="#EAEAEA">지출계정</td>
...
?>
	<tr>
		...
		<td align="right" height="30"><?=$inc?></td>
		<td align="center" height="30"><?=$in_acc?></td>
		<td align="right" height="30"><?=$exp?></td>
		<td align="center" height="30"><?=$out_acc?></td>
...
<?
	...
	if($loan==0) $loan="-";
?>
	<td height="50" bgcolor="#ffffcc" align="center" colspan="10"> 현금시재 : <?= $cash_hand?> &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp; 예금잔고: <?=$bank_balance?> &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp; 차입금잔고 : <?=$dept?> &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp; 대여금잔고 : <?=$loan?> </td>
</tr>
</table>
