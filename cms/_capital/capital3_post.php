...
<?
	...
	$char2_6 = $_POST['char2_6']; $char2_7 = $_POST['char2_7']; $char2_8 = $_POST['char2_8']; $char2_9 = $_POST['char2_9']; $char2_10 = $_POST['char2_10'];
		...
		if($class1_1&&$class2_1){
			 $query1="INSERT INTO `cms_capital_cash_book` (`com_div`, `class1`, `class2`, `pj_seq`, `cont`, `acc`, `in_acc`, `inc`, `out_acc`, `exp`, `evidence`, `worker`, `deal_date`)
							  VALUES('$com_div_1', '$class1_1', '$class2_1', '$pj_seq_1', '$cont_1', '$acc_1', '$in_1', '$inc_1', '$out_1[0]', '$exp_1', '$evi_1', '$worker', '$deal_date')";
			 $result1=mysql_query($query1, $connect);
			 if(!$result1) err_msg('데이터베이스 오류가 발생하였습니다.');     // util.php 파일에 선언한 err_msg()함수 호출, 메세지 출력 후 이전페이지로.
		}
		if($char1_1=='on'){
			 $query1="INSERT INTO `cms_capital_cash_book` (`com_div`, `class1`, `class2`, `cont`, `acc`, `out_acc`, `exp`, `evidence`, `worker`, `deal_date`)
							  VALUES('$com_div_1', '2', '4', '$cont_1_h', '$out_1[1]', '$out_1[0]', '$char2_1', '1', '$worker', '$deal_date')";
			 $result1=mysql_query($query1, $connect);
			 if(!$result1) err_msg('데이터베이스 오류가 발생하였습니다.');     // util.php 파일에 선언한 err_msg()함수 호출, 메세지 출력 후 이전페이지로.
		}
		if($class1_2&&$class2_2){
			 $query2="INSERT INTO `cms_capital_cash_book` (`com_div` ,`class1` ,`class2` ,`cont` ,`acc` ,`in_acc` ,`inc` ,`out_acc` ,`exp` ,`evidence` ,`worker` ,`deal_date`)
							  VALUES('$com_div_2', '$class1_2', '$class2_2', '$cont_2', '$acc_2', '$in_2', '$inc_2', '$out_2[0]', '$exp_2', '$evi_2', '$worker', '$deal_date')";
			 $result2=mysql_query($query2, $connect);
			 if(!$result2) err_msg('데이터베이스 오류가 발생하였습니다.');     // util.php 파일에 선언한 err_msg()함수 호출, 메세지 출력 후 이전페이지로.
		}
		if($char1_2=='on'){
			 $query2="INSERT INTO `cms_capital_cash_book` (`com_div` ,`class1` ,`class2` ,`cont` ,`acc` ,`out_acc` ,`exp` ,`evidence` ,`worker` ,`deal_date`)
							  VALUES('$com_div_2', '2', '4', '$cont_2_h', '$out_2[1]', '$out_2[0]', '$char2_2', '1', '$worker', '$deal_date')";
			 $result2=mysql_query($query2, $connect);
			 if(!$result2) err_msg('데이터베이스 오류가 발생하였습니다.');     // util.php 파일에 선언한 err_msg()함수 호출, 메세지 출력 후 이전페이지로.
		}

		if($class1_3&&$class2_3){
			 $query3="INSERT INTO `cms_capital_cash_book` (`com_div` ,`class1` ,`class2` ,`cont` ,`acc` ,`in_acc` ,`inc` ,`out_acc` ,`exp` ,`evidence` ,`worker` ,`deal_date`)
							  VALUES('$com_div_3', '$class1_3', '$class2_3', '$cont_3', '$acc_3', '$in_3', '$inc_3', '$out_3[0]', '$exp_3', '$evi_3', '$worker', '$deal_date')";
			 $result3=mysql_query($query3, $connect);
			 if(!$result3) err_msg('데이터베이스 오류가 발생하였습니다.');     // util.php 파일에 선언한 err_msg()함수 호출, 메세지 출력 후 이전페이지로.
		}
		if($char1_3=='on'){
			 $query3="INSERT INTO `cms_capital_cash_book` (`com_div` ,`class1` ,`class2` ,`cont` ,`acc` ,`out_acc` ,`exp` ,`evidence` ,`worker` ,`deal_date`)
							  VALUES('$com_div_3', '2', '4', '$cont_3_h', '$out_3[1]', '$out_3[0]', '$char2_3', '1', '$worker', '$deal_date')";
			 $result3=mysql_query($query3, $connect);
			 if(!$result3) err_msg('데이터베이스 오류가 발생하였습니다.');     // util.php 파일에 선언한 err_msg()함수 호출, 메세지 출력 후 이전페이지로.
		}

		if($class1_4&&$class2_4){
			 $query4="INSERT INTO `cms_capital_cash_book` (`com_div` ,`class1` ,`class2` ,`cont` ,`acc` ,`in_acc` ,`inc` ,`out_acc` ,`exp` ,`evidence` ,`worker` ,`deal_date`)
							  VALUES('$com_div_4', '$class1_4', '$class2_4', '$cont_4', '$acc_4', '$in_4', '$inc_4', '$out_4[0]', '$exp_4', '$evi_4', '$worker', '$deal_date')";
			 $result4=mysql_query($query4, $connect);
			 if(!$result4) err_msg('데이터베이스 오류가 발생하였습니다.');     // util.php 파일에 선언한 err_msg()함수 호출, 메세지 출력 후 이전페이지로.
		}
		if($char1_4=='on'){
			 $query4="INSERT INTO `cms_capital_cash_book` (`com_div` ,`class1` ,`class2` ,`cont` ,`acc` ,`out_acc` ,`exp` ,`evidence` ,`worker` ,`deal_date`)
							  VALUES('$com_div_4', '2', '4', '$cont_4_h', '$out_4[1]', '$out_4[0]', '$char2_4', '1', '$worker', '$deal_date')";
			 $result4=mysql_query($query4, $connect);
			 if(!$result4) err_msg('데이터베이스 오류가 발생하였습니다.');     // util.php 파일에 선언한 err_msg()함수 호출, 메세지 출력 후 이전페이지로.
		}

		if($class1_5&&$class2_5){
			 $query5="INSERT INTO `cms_capital_cash_book` (`com_div` ,`class1` ,`class2` ,`cont` ,`acc` ,`in_acc` ,`inc` ,`out_acc` ,`exp` ,`evidence` ,`worker` ,`deal_date`)
							  VALUES('$com_div_5', '$class1_5', '$class2_5', '$cont_5', '$acc_5', '$in_5', '$inc_5', '$out_5[0]', '$exp_5', '$evi_5', '$worker', '$deal_date')";
			 $result5=mysql_query($query5, $connect);
			 if(!$result5) err_msg('데이터베이스 오류가 발생하였습니다.');     // util.php 파일에 선언한 err_msg()함수 호출, 메세지 출력 후 이전페이지로.
		}
		if($char1_5=='on'){
			 $query5="INSERT INTO `cms_capital_cash_book` (`com_div` ,`class1` ,`class2` ,`cont` ,`acc` ,`out_acc` ,`exp` ,`evidence` ,`worker` ,`deal_date`)
							  VALUES('$com_div_5', '2', '4', '$cont_5_h', '$out_5[1]', '$out_5[0]', '$char2_5', '1', '$worker', '$deal_date')";
			 $result5=mysql_query($query5, $connect);
			 if(!$result5) err_msg('데이터베이스 오류가 발생하였습니다.');     // util.php 파일에 선언한 err_msg()함수 호출, 메세지 출력 후 이전페이지로.
		}

		if($class1_6&&$class2_6){
			 $query6="INSERT INTO `cms_capital_cash_book` (`com_div` ,`class1` ,`class2` ,`cont` ,`acc` ,`in_acc` ,`inc` ,`out_acc` ,`exp` ,`evidence` ,`worker` ,`deal_date`)
							  VALUES('$com_div_6', '$class1_6', '$class2_6', '$cont_6', '$acc_6', '$in_6', '$inc_6', '$out_6[0]', '$exp_6', '$evi_6', '$worker', '$deal_date')";
			 $result6=mysql_query($query6, $connect);
			 if(!$result6) err_msg('데이터베이스 오류가 발생하였습니다.');     // util.php 파일에 선언한 err_msg()함수 호출, 메세지 출력 후 이전페이지로.
		}
		if($char1_6=='on'){
			 $query6="INSERT INTO `cms_capital_cash_book` (`com_div` ,`class1` ,`class2` ,`cont` ,`acc` ,`out_acc` ,`exp` ,`evidence` ,`worker` ,`deal_date`)
							  VALUES('$com_div_6', '2', '4', '$cont_6_h', '$out_6[1]', '$out_6[0]', '$char2_6', '1', '$worker', '$deal_date')";
			 $result6=mysql_query($query6, $connect);
			 if(!$result6) err_msg('데이터베이스 오류가 발생하였습니다.');     // util.php 파일에 선언한 err_msg()함수 호출, 메세지 출력 후 이전페이지로.
		}

		if($class1_7&&$class2_7){
			 $query7="INSERT INTO `cms_capital_cash_book` (`com_div` ,`class1` ,`class2` ,`cont` ,`acc` ,`in_acc` ,`inc` ,`out_acc` ,`exp` ,`evidence` ,`worker` ,`deal_date`)
							  VALUES('$com_div_7', '$class1_7', '$class2_7', '$cont_7', '$acc_7', '$in_7', '$inc_7', '$out_7[0]', '$exp_7', '$evi_7', '$worker', '$deal_date')";
			 $result7=mysql_query($query7, $connect);
			 if(!$result7) err_msg('데이터베이스 오류가 발생하였습니다.');     // util.php 파일에 선언한 err_msg()함수 호출, 메세지 출력 후 이전페이지로.
		}
		if($char1_7=='on'){
			 $query7="INSERT INTO `cms_capital_cash_book` (`com_div` ,`class1` ,`class2` ,`cont` ,`acc` ,`out_acc` ,`exp` ,`evidence` ,`worker` ,`deal_date`)
							  VALUES('$com_div_7', '2', '4', '$cont_7_h', '$out_7[1]', '$out_7[0]', '$char2_7', '1', '$worker', '$deal_date')";
			 $result7=mysql_query($query7, $connect);
			 if(!$result7) err_msg('데이터베이스 오류가 발생하였습니다.');     // util.php 파일에 선언한 err_msg()함수 호출, 메세지 출력 후 이전페이지로.
		}

		if($class1_8&&$class2_8){
			 $query8="INSERT INTO `cms_capital_cash_book` (`com_div` ,`class1` ,`class2` ,`cont` ,`acc` ,`in_acc` ,`inc` ,`out_acc` ,`exp` ,`evidence` ,`worker` ,`deal_date`)
							  VALUES('$com_div_8', '$class1_8', '$class2_8', '$cont_8', '$acc_8', '$in_8', '$inc_8', '$out_8[0]', '$exp_8', '$evi_8', '$worker', '$deal_date')";
			 $result8=mysql_query($query8, $connect);
			 if(!$result8) err_msg('데이터베이스 오류가 발생하였습니다.');     // util.php 파일에 선언한 err_msg()함수 호출, 메세지 출력 후 이전페이지로.
		}
		if($char1_8=='on'){
			 $query8="INSERT INTO `cms_capital_cash_book` (`com_div` ,`class1` ,`class2` ,`cont` ,`acc` ,`out_acc` ,`exp` ,`evidence` ,`worker` ,`deal_date`)
							  VALUES('$com_div_8', '2', '4', '$cont_8_h', '$out_8[1]', '$out_8[0]', '$char2_8', '1', '$worker', '$deal_date')";
			 $result8=mysql_query($query8, $connect);
			 if(!$result8) err_msg('데이터베이스 오류가 발생하였습니다.');     // util.php 파일에 선언한 err_msg()함수 호출, 메세지 출력 후 이전페이지로.
		}

		if($class1_9&&$class2_9){
			 $query9="INSERT INTO `cms_capital_cash_book` (`com_div` ,`class1` ,`class2` ,`cont` ,`acc` ,`in_acc` ,`inc` ,`out_acc` ,`exp` ,`evidence` ,`worker` ,`deal_date`)
							  VALUES('$com_div_9', '$class1_9', '$class2_9', '$cont_9', '$acc_9', '$in_9', '$inc_9', '$out_9[0]', '$exp_9', '$evi_9', '$worker', '$deal_date')";
			 $result9=mysql_query($query9, $connect);
			 if(!$result9) err_msg('데이터베이스 오류가 발생하였습니다.');     // util.php 파일에 선언한 err_msg()함수 호출, 메세지 출력 후 이전페이지로.
		}
		if($char1_9=='on'){
			 $query9="INSERT INTO `cms_capital_cash_book` (`com_div` ,`class1` ,`class2` ,`cont` ,`acc` ,`out_acc` ,`exp` ,`evidence` ,`worker` ,`deal_date`)
							  VALUES('$com_div_9', '2', '4', '$cont_9_h', '$out_9[1]', '$out_9[0]', '$char2_9', '1', '$worker', '$deal_date')";
			 $result9=mysql_query($query9, $connect);
			 if(!$result9) err_msg('데이터베이스 오류가 발생하였습니다.');     // util.php 파일에 선언한 err_msg()함수 호출, 메세지 출력 후 이전페이지로.
		}

		if($class1_10&&$class2_10){
			 $query10="INSERT INTO `cms_capital_cash_book` (`com_div` ,`class1` ,`class2` ,`cont` ,`acc` ,`in_acc` ,`inc` ,`out_acc` ,`exp` ,`evidence` ,`worker` ,`deal_date`)
							  VALUES('$com_div_10', '$class1_10', '$class2_10', '$cont_10', '$acc_10', '$in_10', '$inc_10', '$out_10[0]', '$exp_10', '$evi_10', '$worker', '$deal_date')";
		...
		if($char1_10=='on'){
			 $query10="INSERT INTO `cms_capital_cash_book` (`com_div` ,`class1` ,`class2` ,`cont` ,`acc` ,`out_acc` ,`exp` ,`evidence` ,`worker` ,`deal_date`)
							  VALUES('$com_div_10', '2', '4', '$cont_10_h', '$out_10[1]', '$out_10[0]', '$char2_10', '1', '$worker', '$deal_date')";
			 $result10=mysql_query($query10, $connect);
			 if(!$result10) err_msg('데이터베이스 오류가 발생하였습니다.');     // util.php 파일에 선언한 err_msg()함수 호출, 메세지 출력 후 이전페이지로.
		}
