					...
					<!-- ===== subject table end ===== -->
					<?
						$ca_2_2_rlt = mysql_query("select ca_2_2 from cms_mem_auth where user_id='$_SESSION[p_id]' ", $connect);
						$ca_2_2_row = mysql_fetch_array($ca_2_2_rlt);

						if(!$ca_2_2_row[ca_2_2]||$ca_2_2_row[ca_2_2]==0){
					?>
