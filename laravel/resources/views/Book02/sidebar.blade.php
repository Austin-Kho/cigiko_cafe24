        ...
        <div class="col-sm-4 col-md-3 sidebar">
          ...
          <div class="nav nav-sidebar">
            <li class=@if($id==null or $id=='01') active @endif><a href="/book02/01" class="d1">1. 파이썬 프로그래밍 준비와 시작<span class="sr-only">(current)</span></a></li>
            <li class=@if($id=='02') active @endif><a href="/book02/02" class="d2">1.1 파이썬의 역사</a></li>
            <li class=@if($id=='03') active @endif><a href="/book02/03" class="d2">1.2 파이썬을 익히면 좋은 점</a></li>
            <li class=@if($id=='04') active @endif><a href="/book02/04" class="d2">1.3 파이썬 활용이 활발한 개발 분야</a></li>
            <li class=@if($id=='05') active @endif><a href="/book02/05" class="d3">1.3.1 웹 애플리케이션 개발</a></li>
            <li class=@if($id=='06') active @endif><a href="/book02/06" class="d3">1.3.2 크롤링</a></li>
            <li class=@if($id=='07') active @endif><a href="/book02/07" class="d3">1.3.3 데이터 과학과 인공지능 개발</a></li>
            <li class=@if($id=='08') active @endif><a href="/book02/08" class="d2">1.4 파이썬 개발 환경 설치</a></li>
            <li class=@if($id=='09') active @endif><a href="/book02/09" class="d3">1.4.1 우분투</a></li>
            <li class=@if($id=='10') active @endif><a href="/book02/10" class="d3">1.4.2 macOS</a></li>
            <li class=@if($id=='11') active @endif><a href="/book02/11" class="d3">1.4.3 윈도우</a></li>
            <li class=@if($id=='12') active @endif><a href="/book02/12" class="d2">1.5 조금은 어려운 Hello World</a></li>
            <li class=@if($id=='13') active @endif><a href="/book02/13" class="d3">1.5.1 입력과 출력</a></li>
            <li class=@if($id=='14') active @endif><a href="/book02/14" class="d1">2. 파이썬의 주요 특징</a></li>
            ...
            <li class=@if($id=='23') active @endif><a href="/book02/23" class="d1">3. 데이터 타입과 기본 연산자</a></li>
            ...
            <li class=@if($id=='40') active @endif><a href="/book02/40" class="d1">4 흐름 제어와 예외 처리</a></li>
            ...
            <li class=@if($id=='47') active @endif><a href="/book02/47" class="d2">4.4 for 문</a></li>
            <li class=@if($id=='48') active @endif><a href="/book02/48" class="d3">4.4.1 리스트 및 딕셔너리와 함께 for 문 사용하기</a></li>
            <li class=@if($id=='49') active @endif><a href="/book02/49" class="d3">4.4.2 range() 함수와 함께 사용하기</a></li>
            <li class=@if($id=='50') active @endif><a href="/book02/50" class="d2">4.5 break</a></li>
            <li class=@if($id=='51') active @endif><a href="/book02/51" class="d2">4.6 continue</a></li>
            <li class=@if($id=='52') active @endif><a href="/book02/52" class="d3">4.6.1 else</a></li>
            <li class=@if($id=='53') active @endif><a href="/book02/53" class="d2">4.7 pass</a></li>
            <li class=@if($id=='54') active @endif><a href="/book02/54" class="d1">5 함수와 람다</a></li>
            ...
            <li class=@if($id=='59') active @endif><a href="/book02/59" class="d1">6 객체지향과 클래스</a></li>
            ...
            <li class=@if($id=='65') active @endif><a href="/book02/65" class="d1">7 모듈과 패키지</a></li>
            ...
            <li class=@if($id=='75') active @endif><a href="/book02/75" class="d1">8 파일 읽고 쓰기</a></li>
          ...
          <div class="nav nav-sidebar">
            <li class=@if($id=='83') active @endif><a href="/book02/83" class="d1">9 크롤링 애플리케이션 만들기</a></li>
            ...
            <li class=@if($id=='94') active @endif><a href="/book02/94" class="d1">10 SQLite 데이터베이스 사용하기</a></li>
            ...
            <li class=@if($id=='103') active @endif><a href="/book02/103" class="d1">11 플라스크로 API 서버 만들기</a></li>
            ...
            <li class=@if($id=='111') active @endif><a href="/book02/111" class="d1">12 슬랙 봇 만들기</a></li>
            ...
            <li class=@if($id=='125') active @endif><a href="/book02/125" class="d1">13 메시지 큐 만들기</a></li>
            ...
            <li class=@if($id=='138') active @endif><a href="/book02/138" class="d1">14 팬더스로 데이터 분석하기</a></li>
            ...
            <li class=@if($id=='159') active @endif><a href="/book02/159" class="d1">15 Open API로 매시업 API 서버 만들기</a></li>
            ...
            <li class=@if($id=='172') active @endif><a href="/book02/172" class="d1">A pip 설치와 venv 설정하기</a></li>
            ...
            <li class=@if($id=='176') active @endif><a href="/book02/176" class="d3">A.1.3 pip 업그레이드</a></li>
            <li class=@if($id=='177') active @endif><a href="/book02/177" class="d2">A.2 가상 환경 venv</a></li>
            <li class=@if($id=='178') active @endif><a href="/book02/178" class="d3">A.2.1 가상 환경 설정</a></li>
            <li class=@if($id=='179') active @endif><a href="/book02/179" class="d2">A.3 pip와 venv를 동시에 활용하기</a></li>
            <li class=@if($id=='180') active @endif><a href="/book02/180" class="d1">B IPython과 Jupyter Notebook</a></li>
            ...
            <li class=@if($id=='186') active @endif><a href="/book02/186" class="d1">C PEP 8</a></li>
            <li class=@if($id=='187') active @endif><a href="/book02/187" class="d2">C.1 코드 레이아웃</a></li>
            <li class=@if($id=='188') active @endif><a href="/book02/188" class="d3">C.1.1 들여쓰기</a></li>
            <li class=@if($id=='189') active @endif><a href="/book02/189" class="d3">C.1.2 탭이냐 스페이스냐</a></li>
            <li class=@if($id=='190') active @endif><a href="/book02/190" class="d3">C.1.3 한 행의 길이는?</a></li>
            <li class=@if($id=='191') active @endif><a href="/book02/191" class="d3">C.1.4 빈 행은 어떻게 얼마나?</a></li>
            <li class=@if($id=='192') active @endif><a href="/book02/192" class="d3">C.1.5 소스 코드 파일의 인코딩은 어떻게?</a></li>
            <li class=@if($id=='193') active @endif><a href="/book02/193" class="d3">C.1.6 imports</a></li>
            <li class=@if($id=='194') active @endif><a href="/book02/194" class="d2">C.2 공백 표현과 구문</a></li>
            <li class=@if($id=='195') active @endif><a href="/book02/195" class="d3">C.2.1 성가신 것들</a></li>
            <li class=@if($id=='196') active @endif><a href="/book02/196" class="d3">C.2.2 그 외의 추천하는 방법</a></li>
