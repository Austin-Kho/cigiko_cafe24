      ...
      <section>
        <article class="">
          <p>
            ...
            <pre><code class="python">>>> def hello(name):<br>       print('hello ' + name)<br>&nbsp;<br>>>> hello('Alice')<br>Hello Alice</code></pre>
          </p>
          ...
          <p>
            ...
            <pre><code class="python">>>> import random<br>>>> def getAnswer(answerNumber):<br>       if answerNumber == 1:<br>          <strong>return</strong> 'It is certain'<br>       elif answerNumber == 2:
          ...
          <br>>>> r = random.randint(1, 9)<br>>>> fortune = getAnswer(r)<br>>>> print(fortune)<br>My reply is no</code></pre>
          </p>
          ...
          <p>
            ...
            <pre><code class="python">>>> spam = print('Hello!')<br>Hello!<br>>>> None == spam<br>True</code></pre>
          ...
          <p>
            ...
            <pre><code class="python">>>> print('Hello')<br>>>> print('World')<br>Hello<br>World</code></pre>
            <pre><code class="python">>>> print('Hello' <strong>end</strong>='')<br>>>> print('World')<br>HelloWorld</code></pre>
            <pre><code class="python">>>> print('cats', 'dogs', 'mice')<br>cats dogs mice</code></pre>
            <pre><code class="python">>>> print('cats', 'dogs', 'mice', <strong>sep</strong>=',')<br>cats,dogs,mice</code></pre>
          </p>
          ...
          <p>
            ...
            <pre><code class="python">>>> def spam():<br>       eggs = 31337<br><br>>>> spam()<br>>>> print(eggs)<br>Traceback (most recent call last):
...
NameError: name 'eggs' is not defined</code></pre>
            <p>
              ...
              <pre><code class="python">>>> def spam():<br>       globas eggs<br>       eggs = 'spam'<br><br>>>> eggs = 'global'<br>>>> spam()<br>>>> print(eggs)<br>spam</code></pre>
            </p>

            <p>
              <h5><strong>■ 예외 처리</strong></h5>
              <p>'0으로 나누기'오류가 나는 다음 프로그램을 보자.</p>
              <pre><code class="python">>>> def spam(divideBy)<br>       return 42 / divideBy<br><br>>>> print(spam(2))<br>21.0<br>>>> print(spam(12))<br>3.5<br>>>> print(spam(0))<br>Traceback (most recent call last):
  File "&lt;stdin>", line 1, in &lt;module>
  File "&lt;stdin>", line 2, in spam
ZeroDivisionError: division by zero<br>>>> print(spam(1))<br>42.0</code></pre>
              <p>try 절에서 원래 실행할 코드블록을 적고 except 키워드와 에러명을 적은 절에 에러시에 실행할 코드를 적는다. </p>
              <pre><code class="python">>>> def spam(divideBy)<br>       try:<br>          return 42 / divideBy<br>       except ZeroDivisionError:<br>          print('Error: Invalid argument.')<br><br>>>> print(spam(2))<br>21.0<br>>>> print(spam(12))<br>3.5<br>>>> print(spam(0))<br>Error: Invalid argument.<br>None<br>>>> print(spam(1))<br>42.0</code></pre>
            </p>
          </p>
