      ...
      <section>
        <article class="">
          <p>
            ...
            <pre><code class="python">>>> myCat = {'size': 'fat', 'color': 'gray', 'disposition': 'loud'}<br>>>> myCat['size']<br>'fat'<br>>>> 'My cat has ' + myCat['color'] + ' fur.'<br>'My cat has gray fur.'</b></code></pre>
          </p>

          <p>
            <h5><strong>■ 사전과 리스트의 차이</strong></h5>
            <p>리스트와는 달리 사전의 아이템들은 순서가 없다.</p>
            <pre><code class="python">>>> spam = ['cats', 'dogs', 'moose']<br>>>> bacon = ['dogs', 'moose', 'cats']<br>>>> spam == bacon<br><strong>False</strong>
          ...
          <p>
            ...
            <pre><code class="python">>>> spam = {'name': 'Zophie', 'age': 7}<br>>>> 'name' in spam.keys()<br>True<br>>>> 'Zophie' in spam.values()<br>True<br>'color' in spam.keys()<br>False<br>'color' not in spam.keys()<br>True<br>>>> 'color' in spam<br>False</code></pre>
          </p>
          ...
          <p>
            ...
            <pre><code class="python">>>> picnicItems = {'apples': 5, 'cups': 2}<br>>>> 'I am bringing ' + str(picnicItems.get('cups', 0)) + ' cups.'<br>'I am bringing 2 cups.'<br>>>> 'I am bringing ' + str(picnicItems.get('eggs', 0)) + ' eggs.'<br>'I am bringing 0 eggs.'</code></pre>
            <p><strong>▶ setdefault()</strong> : 사전 안의 어떤 특정한 키에 이미 값이 존재하지 않는 경우에만 그 키에 값을 설정할 때가 종종 있다.</p>
            <pre><code class="python">>>> spam = {'name': 'Pooka', 'age': 5}<br>>>> if 'color' not in spam:<br>        spam['color'] = 'black'</code></pre>
            ...
            <pre><code class="python">>>> spam = {'name': 'Pooka', 'age': 5}<br>>>> spam.setdefault('color', 'black')<br>'black'<br>>>> spam<br>{'color': 'black', 'age': 5, 'name': 'Pooka'}
              <br>>>> spam.setdefault('color': 'white')<br>'black'<br>>>> spam<br>{'color': 'black', 'age': 5, 'name': 'Pooka'}</code></pre>
          </p>
          ...
          <p>
            ...
            <ul>
              ...
              <pre><code class="python">if 'color' not in spam:<br>    spam['color'] = 'black'</code></pre>
