  ...
  <div class="chapter">
    <section>
      <article>
        ...
        <p class="bg-info"><strong>NOTE_ 초기화와 클래스 인스턴스 생성</strong><br>__init__()함수에 self라는 파라미터를 전달한다는 점에서 초기화하는 시점에서 이미 클래스 인스턴스의 생성은 완료되어 있다. __init__()함수는 말 그대로 초기화를 한다. <br><br>정말로 초기화하는 순간에 무언가를 하고 싶다면 파이썬 문서의 '<a href="https://docs.python.org/3/reference/datamodel.html#basic-customization" target="_blank">Basic customization</a>'을 참고한다.</p>
