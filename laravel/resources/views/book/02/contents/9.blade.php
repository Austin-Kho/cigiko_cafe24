  ...
  <div class="chapter">
    <section>
      <article>
        ...
        <div class="tip"><h4>TIP</h4> <p>파이썬의 파일 읽고 쓰기와 관련한 더 자세한 내용은 파이썬 개발 문서의 '<a href="https://docs.python.org/3.5/tutorial/inputoutput.html#reading-and-writing-files" target="_blank">7.2 Reading and Writing Files</a>'를 참고한다.</p></div>
      </article>
    </section>
  </div>
  ...
  <div class="chapter">
    ...
    <section>
      <article>
        ...
        <div class="tip"><h4>TIP</h4><p>이터레이터(iterator) 속성을 갖는(혹은 구현한) 모든 객체는 순회 가능하다고 표현하며 for 문 등에서 차례로 무언가를 꺼내 오는 작업에 사용한다. 더 자세한 설명은 파이썬 개발문서 '<a href="https://docs.python.org/3/tutorial/classes.html#iterators" target="_blank">9.8 Iterators</a>'를 참고한다.</p></div>
