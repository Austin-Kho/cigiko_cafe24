  ...
  <div class="chapter">
    <section>
      <article>
        ...
        <div class="tip"><h4>NOTE_ 내장함수와 기본 라이브러리</h4><p>파이썬 역시 다른 프로그래밍 언어처럼 언어 안에 내장되어 사용할 수 있는 함수들이 있다. 이를 내장함수라고 한다. 예를 들어 print() 는 대표적인 내장함수이다. 파이썬 개발 문서의 '<a href="https://docs.python.org/3/library/functions.html" target="_blank">2. Built-in Functions</a>' 기준으로 내장함수는 68개이다. 해당 개발 문서를 참고해서 내장함수에 무엇이 있는지 살펴보길 권한다.
        <br><br>또한 내장함수는 아니지만 파이썬 개발환경과 함께 설치되는 라이브러리에도 여러가지 함수가 있다. '<a href="https://docs.python.org/3.6/library/index.html#library-index" target="_blank">The Python Standard Library</a>'에서 확인할 수 있다. 이 문서는 파이썬에 익숙해지면 자주 보게 될 것이다.</p></div>
      </article>
    </section>
  </div>