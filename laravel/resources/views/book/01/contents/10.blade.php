      ...
      <section>
        <article class="">
          ...
          <p>
            ...
            <pre><code class="python">>>> import os<br>>>> os.path.join('usr', 'bin', 'spam')<br>'usr/bin/spam'</code></pre>
            ...
            <pre><code class="python">>>> myFiles = ['accounts.txt', 'details.csv', 'invite.docx']<br>>>> for filename in myFiles:<br>        print(os.path.join('C:\\Users\\asweigart', filename))
            <br>C:\Users\asweigart\accounts.txt<br>C:\Users\asweigart\details.csv<br>C:\Users\asweigart\invite.docx</code></pre>
          </p>
          ...
          <p>
            ...
            <pre><code class="python">>>> import os<br>>>> os.getcwd()<br>'C:\\Python34'<br>>>> os.chdir('C:\\Windows\\System32')<br>'C:\\Windows\\System32'</code></pre>
          ...
          <p>
            ...
            <pre><code class="python">>>> import os<br>>>> os.makedirs('C:\\delicious\\walnut\\waffles')</code></pre>
          ...
          <p>
            ...
            <pre><code class="python">>>> os.path.abspath('.')<br>'C:\\Python34'<br>>>> os.path.abspath('.\\Scripts')<br>'C:\\Python34\\scripts'<br>>>> os.path.isabs('.')<br>False<br>>>> os.path.isabs(os.path.abspath('.'))<br>True</code></pre>
            <p>os.path.abspath() 함수가 호출되었을 때 C:\\Python34가 작업 디렉토리였으므로 '점 한 개(.)' 폴더는 절대 경로 'C:\\Python34'를 뜻한다.</p>
            <pre><code class="python">>>> os.path.relpath('C:\\Windows', 'C:\\')<br>'Windows'<br>>>> os.path.relpath('C:\\Windows', 'C:\\spam\\eggs')<br>'..\\..\\Windows'<br>>>> os.getcwd()<br>'C:\\Python34'</code></pre>
            ...
            <pre><code class="python">>>> path = 'C:\\Windows\\System32\\calc.exe'<br>>>> os.path.basename(path)<br>'calc.exe'<br>>>> os.path.dirname(path)<br>'C:\\Windows\\System32'</code></pre>
            <p>경로의 디렉토리 이름과 기본 이름이 함께 필요하면 다음과 같이 os.path.split() 함수를 호출해서 두 개의 문자열 튜플 값을 얻을 수 있다.</p>
            <pre><code class="python">>>> calcFilePath = 'C:\\Windows\\System32\\calc.exe'<br>>>> os.path.split(calcFilePath)<br>('C:\\Windows\\System32', 'calc.exe')</code></pre>
            <p>os.path.dirname()과 os.path.basename()을 호출하고 돌려받은 값을 튜플에 넣으면 같은 튜플을 만들 수 있다는 것을 알 수 있다.</p>
            <pre><code class="python">>>> (os.path.dirname(calcFilePath), os.path.basename(calcFilePath))<br>('C:\\Windows\\System32', 'calc.exe')</code></pre>
            ...
            <pre><code class="python">>>> calcFilePath.split(os.path.sep)<br>['C:', 'Windows', 'System32', 'calc.exe']</code></pre>
            <p>OS X와 리눅스 시스템의 경우, 돌려받는 리스트의 시작에는 빈 문자열이 있을 것이다.</p>
            <pre><code class="python">>>> '/usr/bin'.split(os.path.sep)<br>['', 'usr', 'bin']</code></pre>
          ...
          <p>
            ...
            <pre><code class="python">>>> os.path.getsize('C:\\Windows\\System32\\calc.exe')<br>776192<br>>>> os.listdir('C:\\Windows\\System32')<br>['0049', '12520437.cpx', '12520850.cpx', '5U877.ax', 'aaclient.dll,<br>--snip--<br>'xwtpdui.dll', 'xwtpw32.dll', 'zh-CN', 'zh-HK', 'zh-TW', 'zipfldr.dll']</code></pre>
          </p>
        </article>
      </section>
    </div>
