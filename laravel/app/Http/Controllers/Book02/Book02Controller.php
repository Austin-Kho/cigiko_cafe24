...
class Book02Controller extends Controller
{
  public function index($id='1'){
    ...
    $view->id = $id;
    $view->sub[1] = '1. 파이썬 프로그래밍 준비와 시작';
    $view->sub[2] = '2. 파이썬의 주요 특징';
    $view->sub[3] = '3. 데이터 타입과 기본 연산자';
    $view->sub[4] = '4. 흐름 제어와 예외 처리';
    $view->sub[5] = '5. 함수와 람다';
    $view->sub[6] = '6. 객체지향과 클래스';
    $view->sub[7] = '7. 모듈과 패키지';
    $view->sub[8] = '8. 파일 읽고 쓰기';
    $view->sub[9] = '9. 크롤링 애플리케이션 만들기';
