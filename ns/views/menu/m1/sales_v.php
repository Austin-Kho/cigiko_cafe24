<ul class="nav nav-tabs" role="tablist">
	<li role="presentation" class="<?if( !$this->uri->segment(3) or $this->uri->segment(3)=='1') echo 'active'; else echo '';?>">
		<a href="<?php echo $this->config->base_url('m1/sales/1'); ?>"><strong>계 약 관 리</strong></a>
	</li>
	<li role="presentation" class="<?if( $this->uri->segment(3)=='2') echo 'active'; else echo '';?>">
		<a href="<?php echo $this->config->base_url('m1/sales/2'); ?>"><strong>수 납 관 리</strong></a>
	</li>
</ul>
<!-- ---------------------------------mdi-menu end------------------------------------ -->
...
?>
		<li role="presentation" class="<?php if(( !$this->uri->segment(4) && $j==1) or $this->uri->segment(4)==$j) echo 'active'; ?>">
			<a href="<?php echo $this->config->base_url('m1/sales')."/"; if($this->uri->segment(3)) {echo $this->uri->segment(3).'/'.$j;} else {echo '1/'.$j;}?>"><?php echo $s_di[0][$i]; ?></a>
		</li>
<?
	endfor;
else :
...
?>
		<li role="presentation" class="<?php if(( !$this->uri->segment(4) && $j==1) or $this->uri->segment(4)==$j) echo 'active'; ?>">
			<a href="<?php echo $this->config->base_url('m1/sales')."/"; if($this->uri->segment(3)) {echo $this->uri->segment(3).'/'.$j;} else {echo '1/'.$j;}?>"><?php echo $s_di[1][$i]; ?></a>
		</li>
<?
	endfor;
endif;
