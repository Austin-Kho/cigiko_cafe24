...
<body>
	<div id="main">
		...
		<article id="board_area">
			...
			<form class="form-horizontal" method="post" id="write_action" action="">
				<fieldset>
					<div class="control-group">
						...
						<label for="input02" class="control-label">시작일</label>
						<div class="controls">
		...
		<footer id="footer">
			<blockquote>
				<p class="azubu" href="http://www.cikorea.net/" target="blank">CodeIgniter 한국사용자포럼</p>
