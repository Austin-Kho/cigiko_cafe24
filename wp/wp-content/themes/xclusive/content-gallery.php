<?php
/**
 * XClusive - Template for displaying gallery formats
 *
 ...
 * @filesource  wp-content/themes/xclusive/content-gallery.php
 ...
 ?>
 	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<div class="entry-content">
			<?php if ( is_single() || ! xclusive_get_post_gallery() ) : ?>
            ...
            <?php elseif( has_post_thumbnail() ) : ?>
            	  <a href="<?php esc_url( the_permalink() ); ?>" title="<?php the_title_attribute(); ?>" class="image url"><?php the_post_thumbnail( ); ?></a>
            <?php else : ?>
				<?php echo xclusive_get_first_gallery_image(); ?>
			<?php endif; // is_single() ?>
		</div><!-- .entry-content -->         
