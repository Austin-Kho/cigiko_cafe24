			...
			<table cellspacing="0" cellpadding="0" class="table table-striped">
				...
				<?php	foreach ($list as $lt) : //컨트롤러에서 $data['list']로 뷰에 전달된 내용을 $list배열로 사용	?>
					<tr><!-- 현재행이 루프수만큼 반복 // 모델에서 객체배열로 반환했기 때문에 $lt->created_date형태로 사용 //일반배열 반환시는 $lt['created_date']형태로 사용 -->
						<th scope="row"><a href="/ci3/todo/main/view/<?php echo $lt->id; ?>" rel="external"><?php echo $lt->id; ?></a></th>
						<td><!-- 컨텐츠에 보기 페이지 주소를 미리 링크 함 // 주소형태와 컨트롤러에 전달할 변수는 개발자가 만드는 것이므로 미리 선언하고 그에 맞게 다음 절에서 todo보기 함수인 view();를 만든다. -->
							<a href="/ci3/todo/main/view/<?php echo $lt->id; ?>" rel="external"><?php echo $lt->content; ?></a></td>
						<td>
				...
				<tfoot>
					<tr>
						<th colspan="4"><a href="/ci3/todo/index.php/main/write/" class="btn btn-success">쓰기</a></th>
					</tr>
				</tfoot>
			</table>
			<div><p></p></div>
