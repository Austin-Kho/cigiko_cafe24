 ...
 */
$autoload['libraries'] = array('database', 'session', 'managelayout', 'member', 'cbconfig', 'board', 'user_agent', 'depositconfig', 'cmallconfig', 'events');
 ...
 */
$autoload['helper'] = array('url', 'form', 'basic', 'thumbnail', 'cookie');
